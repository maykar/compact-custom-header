...
* Avoid using ```header: false``` unless you're using lovelace yaml mode. Otherwise you'll have no way to edit your config other than editing .storage (which you shouldn't do). Wait for expanding tab feature, coming soon.
