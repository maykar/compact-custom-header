...
* To use with panel view place this card in a vertical stack like the example below. This is to make it part of the panel, otherwise the "card" isn't "displayed" and won't load. If you're using another type of container card in panel view you can just insert this card into it and not worry about the vertical stack.
