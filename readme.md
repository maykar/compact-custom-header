...
* **user:** A Home Assistant username or user's name. This will be the username if the user has no name set otherwise it is the user's name. You can look to the bottom of the editor to see which to use.
