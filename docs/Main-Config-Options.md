...
After installing CCH, select "Configure UI" from the options menu. There will be a new item in the options menu, "CCH Settings". With the exception of styling, everything in CCH can be configured using this UI. This editor is not available when using Lovelace in YAML Mode.<br><br>
